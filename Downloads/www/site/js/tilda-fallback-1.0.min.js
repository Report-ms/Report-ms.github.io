function t_fallback__init() {
    ...
    "loading" != document.readyState ? t_fallback__initTags("IMG") : document.addEventListener("DOMContentLoaded", (function() {
...
function t_fallback__initTags(t) {
    ...
    Array.prototype.forEach.call(a, (function(a) {
        "set" !== a.isReloadFuncSet && (a.onerror = function() {
            t_fallback__reloadSRC(this),
            this.isReloadFuncSet = "set"
        }
        ),
        "y" === a.loaderr && (a.loaderr = "",
...
function t_fallback__reloadSRC(t) {
    "function" == typeof t_falladv__reloadSRC ? t_falladv__reloadSRC(t) : (t_fallback__loadAdvancedJS(),
    setTimeout((function() {
...
function t_fallback__handleTimeout() {
    "loading" == document.readyState && "object" == typeof window.performance && null !== document.head.querySelector('script[src^="https://static.tildacdn."]') && (t_fallback__loadAdvancedJS(),
    setTimeout((function() {
