function t_sldsInit(t, e) {
    ...
    if (s) {
        var i = s.querySelector(".t-slds__items-wrapper"), r;
        if (i)
            if (!i.getAttribute("data-slider-initialized")) {
                ...
                if (d) {
                    ...
                    var l = d.length, o = d[0], n = d[d.length - 1], _ = window.innerWidth, c = parseInt(i.getAttribute("data-slider-items-in-row"), 10) || 0, u = i.getAttribute("data-slider-with-cycle"), p = parseFloat(i.getAttribute("data-slider-transition")), f;
                    ...
                    "true" !== i.getAttribute("data-slider-stop")) {
                        ...
                        i.classList.contains("t-slds_animated-fast") || i.classList.contains("t-slds_animated-slow") || i.classList.contains("t-slds_animated-none") || i.classList.add("t-slds_animated-fast");
                        var m = c;
                        t_slds_setItemsInRow(t),
                        t_slds_changeImageUrl(t);
                        var y = 8 === document.documentMode || 9 === document.documentMode;
                        y && (i.classList.remove("t-slds_animated-fast"),
                        ...
                        i.getAttribute("data-slider-totalslides") || i.setAttribute("data-slider-totalslides", l);
                        var v = 1
                        ...
                        a ? _ > 960 && ("true" === i.getAttribute("data-feeds-posts-loaded") ? (t_slds__initFeedsSlider(t, s, e),
                        t_slds_initSliderControls(t, e)) : document.addEventListener("feedsLoadPosts", (function() {
                        ...
                        i.getAttribute("data-slider-timeout") > 0 ? t_slds_initAutoPlay(t, v, l, e) : i.addEventListener("slideAutoplayTimerReady", (function() {
                            i.getAttribute("data-slider-timeout") > 0 && t_slds_initAutoPlay(t, v, l, e)
                        }
                        )),
                        s.querySelectorAll(".t-slds__item-loaded").length < l + 2 && t_slds_UpdateImages(t, v),
                        ...
                        a && (s.removeEventListener("displayChanged", t_slds_updateFeedsSliderOnResize),
                        ...
                        window.t_slds__isiOS && ("complete" === document.readyState ? t_slds__hideMobileSlides(s.querySelector(".t-slds__item_active")) : window.addEventListener("load", (function() {
                        ...
                        h && h.addEventListener("allRecPaddingInit", (function() {
                            t_slds_updateSlider(t)
                        }
                        )),
...
function t_slds__removeAutoplayByVideo(t) {
    ...
    if (e) {
        var s = e.closest(".t-slds__items-wrapper"), i;
        if (s)
            s.getAttribute("data-slider-interval-id") && (s.setAttribute("data-slider-stopped", "yes"),
...
function t_slds__createDummies(t, e, s) {
    var i, r = s.querySelectorAll(".t-slds__item:not(.t-slds__item_dummy)").length, a = parseInt(s.getAttribute("data-slider-items-in-row"), 10) || 0, d = s.getAttribute("data-slider-with-cycle"), l = s.classList.contains("js-feed-container"), o = !1, n = !1;
    if (t) {
    ...
    if (!l && t && !s.querySelector('.t-slds__item[data-slide-index="' + (r + 1) + '"]')) {
        var m = t.cloneNode(!0);
        if (m.setAttribute("data-slide-index", r + 1),
    ...
    o && (_.classList.add("t-zoomable"),
    _.setAttribute("data-zoomable", "yes")),
    n && (c.classList.add("t-zoomable"),
    c.setAttribute("data-zoomable", "yes"))
}
function t_slds__hideMobileSlides(t) {
    if (t) {
        ...
        if (!s || "scroll" !== s.overflowX || "flex" !== s.display) {
            ...
            if (!(i.length <= 2 * r)) {
                for (var a = t.getAttribute("data-slide-index"), d = [a = parseInt(a, 10)], l = 1; l < r; l++)
...
function t_slds_updateFeedsSliderOnResize(t, e, s) {
    var i = e.querySelector(".t-slds__items-wrapper"), r;
    i && (i.classList.contains("js-feed-container") && (window.innerWidth > 960 ? "true" === i.getAttribute("data-feeds-posts-loaded") ? (t_slds__initFeedsSlider(t, e, s),
    t_slds_initSliderControls(t, s)) : document.addEventListener("feedsLoadPosts", (function() {
        t_slds__initFeedsSlider(t, e, s),
...
function t_slds_setItemsInRow(t, e) {
    var s = t_slds__getRec(t);
    if (s) {
        var i = s.querySelector(".t-slds__items-wrapper"), r, a;
        if (i)
            (i.getAttribute("data-slider-items-in-row") || 0) && (window.innerWidth <= 960 && (a = 2),
...
function t_slds_initSliderControls(t, e) {
    ...
    if (s) {
        ...
        if (i) {
            var r = i.getAttribute("data-slider-items-in-row") || 0, a = s.querySelector(".t-slds__container .t-slds__item"), d = s.querySelector(".t-slds__container"), l = r > 0 && a && d ? a.offsetWidth : d.offsetWidth, o;
            if ("true" !== i.getAttribute("data-slider-stop")) {
                ...
                n.length && Array.prototype.forEach.call(n, (function(r) {
                    r.addEventListener("click", (function() {
                        var r = t_slds_getCurrentTranslate(s), a = i.getAttribute("data-slider-animated"), d = parseFloat(i.getAttribute("data-slider-pos")), l = parseFloat(i.getAttribute("data-slider-totalslides")), o = i.getAttribute("data-slider-with-cycle"), n = "", _;
                        "" == a && (i.setAttribute("data-slider-animated", "yes"),
                        "left" === this.getAttribute("data-slide-direction") ? "false" == o && 1 == d ? d = 1 : d-- : "false" == o && d == l ? d = l : d++,
                ...
                _.length && Array.prototype.forEach.call(_, (function(r) {
                    r.addEventListener("click", (function() {
                        var a = parseInt(r.getAttribute("data-slide-bullet-for"), 10), d;
...
function t_slds_animate(t, e, s) {
    ...
    requestAnimationFrame((function r(a) {
        ...
        var l = t(d);
        e(l),
        d < 1 ? requestAnimationFrame(r) : "y" !== window.lazy && "yes" !== document.querySelector("#allrecords").getAttribute("data-tilda-lazy") || t_slds_onHammerLoad("t_lazyload_update", (function() {
            t_lazyload_update()
        }
        ))
    }
...
function t_slideMoveWithoutAnimation(t, e, s) {
    ...
    if (i) {
        ...
        if (r) {
            var a = parseFloat(r.getAttribute("data-slider-pos")), d, l = (r.getAttribute("data-slider-items-in-row") || 0) > 0 ? i.querySelector(".t-slds__container .t-slds__item").offsetWidth : i.querySelector(".t-slds__container").offsetWidth, o = parseFloat(r.getAttribute("data-slider-totalslides")), n = r.classList.contains("t-slds_animated-none");
            a > o + 1 && (a = 1);
            ...
            if (n) {
                ...
                if (p && 0 === i.querySelectorAll(".t-slds__item_dummy").length) {
                    var m = p.cloneNode(!0);
                    if (m.classList.add("t-slds__item_dummy"),
                    ...
                    i.classList.contains("js-product"))
                        ...
                        var y = i.querySelector(".t-store") || i.querySelector(".js-product");
                    y ? (t_slds_fadeOut(m, 150, (function() {
...
function t_slideMove(t, e, s) {
    ...
    if (i) {
        var r = i.querySelector(".t-slds__items-wrapper");
        if (r) {
            var a = i.querySelectorAll(".t-slds__item:not(.t-slds__item_dummy)"), d = r.classList.contains("js-feed-container"), l = parseInt(r.getAttribute("data-slider-items-in-row") || 0), o = parseInt(r.getAttribute("data-feed-show-count") || 0), n = l > 0 ? i.querySelector(".t-slds__container .t-slds__item").offsetWidth : i.querySelector(".t-slds__container").offsetWidth, _ = parseFloat(r.getAttribute("data-slider-transition")), c = parseFloat(r.getAttribute("data-slider-pos")), u = parseFloat(r.getAttribute("data-slider-totalslides")), p = r.getAttribute("data-slider-cycle"), f = r.classList.contains("t-slds_animated-none"), m = r.getAttribute("data-slider-timeout") > 0, y = i.querySelector(".t-slds__arrow_wrapper-right"), v = i.querySelector(".t-slds__arrow_wrapper-left"), g;
            ...
            var h = !!navigator.userAgent.match("CriOS"), S;
            if (_ || 0 === _ || (_ = 300),
            c > u + 1 && (c = 1,
            r.setAttribute("data-slider-pos", 1)),
            "true" !== r.getAttribute("data-slider-stop")) {
                if (y)
                    if (d) {
                        var w = a[a.length - 1]
                          , q = parseInt(w.getAttribute("data-slide-index"), 10);
                        if (l < u && t_slds_fadeIn(y, 300),
                        q < u && l > 0 && (c == q - o + 1 || q === o)) {
                            ...
                            q === u && c === u - l + 1 && t_slds_fadeOut(y, 300)
                    } else
                        "false" == r.getAttribute("data-slider-with-cycle") && (c == u || l > 1 && c == u - l + 1) ? t_slds_fadeOut(y, 300) : t_slds_fadeIn(y, 300);
                v && ("false" == r.getAttribute("data-slider-with-cycle") && 1 == c ? t_slds_fadeOut(v, 300) : t_slds_fadeIn(v, 300)),
                r.classList.add("t-slds_animated"),
                A >= 13 && h && !f ? t_slide_MoveAnimation(r, c, n, _) : r.style.transform = "translateX(-" + n * c + "px)",
                t_triggerEvent(r, "slideChangeStart"),
                setTimeout((function() {
                    r.classList.remove("t-slds_animated"),
                    r.setAttribute("data-slider-animated", ""),
                    "yes" == (p = r.getAttribute("data-slider-cycle")) && (c == u + 1 && (c = 1),
                    0 == c && (c = u),
                    A >= 13 && h && !f ? t_slide_MoveAnimation(r, c, n, 0) : r.style.transform = "translateX(-" + n * c + "px)",
                ...
                i.querySelectorAll(".t-slds__item-loaded").length < u + 2 && t_slds_UpdateImages(t, c)
            }
        }
    }
}
function t_slds_updateSlider(t) {
    ...
    if (e) {
        ...
        if (s) {
            ...
            _ && (_.style.display = "false" === n && (o - i <= 0 || l === o) ? "none" : ""),
...
function t_slds_UpdateImages(t, e) {
    ...
    if (s) {
        ...
        i && (i.classList.add("t-slds__item-loaded"),
...
function t_slds_ActiveCaption(t, e, s) {
    ...
    if (i) {
        ...
        0 == e ? a = i.querySelector('.t-slds__caption[data-slide-caption="' + s + '"]') : e == s + 1 && (a = i.querySelector('.t-slds__caption[data-slide-caption="1"]')),
...
function t_slds_ActiveBullet(t, e, s, i) {
    ...
    if (l) {
        ...
        i && i.thumbsbulletGallery && e >= r && e != s + 1 || s >= r && 0 == e ? n = l.querySelector('.t-slds__bullet[data-slide-bullet-for="' + r + '"]') : 0 == e ? n = l.querySelector('.t-slds__bullet[data-slide-bullet-for="' + s + '"]') : e == s + 1 && (n = l.querySelector('.t-slds__bullet[data-slide-bullet-for="1"]')),
        n) {
    ...
    if (i) {
        ...
        if (o.length)
            ...
            Array.prototype.forEach.call(n, (function(t) {
                t.src && (-1 !== t.src.indexOf("&enablejsapi=1") && t.contentWindow.postMessage('{"event":"command","func":"pauseVideo","args":""}', "*"),
                -1 === t.src.indexOf("vimeo") || -1 === t.src.indexOf("&amp;api=1") && -1 === t.src.indexOf("&api=1") || t.contentWindow.postMessage('{"method":"pause","value":"true"}', "*"))
            }
            )),
        ...
        0 == e && !1 === l)
            ...
            e == s + 1 && !0 === l && (d = i.querySelector('.t-slds__item[data-slide-index="1"]'));
        d && (d.classList.add("t-slds__item_active"),
...
function t_slds_SliderWidth(t) {
    ...
    if (e) {
        ...
        if (s) {
            var i = getComputedStyle(s), r = parseInt(i.paddingLeft) || 0, a = parseInt(i.paddingRight) || 0, d = s.clientWidth - (r + a), l = e.querySelectorAll(".t-slds__item:not(.t-slds__item_dummy)").length, o = e.querySelector(".t-slds__items-wrapper"), n;
            if ("true" != o.getAttribute("data-slider-stop")) {
                var _ = 0;
                o && (_ = o.getAttribute("data-slider-items-in-row"),
                o.style.width = d * l + "px"),
                window.innerWidth <= 640 ? _ = 1 : window.innerWidth <= 960 && _ > 1 && (_ = 2);
                var c = _ > 1 ? d / _ : d;
                if (c > 0) {
...
function t_slds_SliderArrowsHeight(t) {
    ...
    if (e) {
        ...
        o && n.length && Array.prototype.forEach.call(n, (function(t) {
            t.style.height = o + "px";
...
function t_slds_initAutoPlay(t, e, s, i) {
    ...
    if (a) {
        ...
        if (l) {
            var o = parseFloat(l.getAttribute("data-slider-timeout")), n = "", _ = l.getAttribute("data-slider-interval-id"), c;
            if (_ && clearInterval(_),
            "true" !== l.getAttribute("data-slider-stop")) {
                var u;
                ...
                var p = a.getBoundingClientRect().top + window.pageYOffset, f = p + a.offsetHeight, m, y;
                window.addEventListener("resize", t_throttle((function() {
                    p = a.getBoundingClientRect().top + window.pageYOffset,
                    f = p + a.offsetHeight
                }
                ))),
                void 0 !== document.hidden ? (m = "hidden",
                y = "visibilitychange") : void 0 !== document.msHidden ? (m = "msHidden",
                y = "msvisibilitychange") : void 0 !== document.webkitHidden && (m = "webkitHidden",
                ...
                document.addEventListener(y, (function() {
                    if (document[m])
                        ...
                        p = a.getBoundingClientRect().top + window.pageYOffset,
                        (f = p + a.offsetHeight) > e && p < s && "none" !== t && "y" !== l.getAttribute("data-slider-stopped-by-video") && l.setAttribute("data-slider-stopped", "")
                    }
                }
                ), !1),
                1 === a.length && window.bind("scroll", t_throttle((function() {
                    var t = getComputedStyle(a).display
                      , e = window.pageYOffset
                      , s = e + window.innerHeight;
                    "none" !== t ? (p = a.getBoundingClientRect().top + window.pageYOffset,
                    (f = p + a.offsetHeight) > e && p < s && "y" !== l.getAttribute("data-slider-stopped-by-video") ? l.setAttribute("data-slider-stopped", "") : "" === l.getAttribute("data-slider-stopped") && l.setAttribute("data-slider-stopped", "yes")) : r || l.setAttribute("data-slider-stopped", "yes")
                }
                )));
                var v = setInterval((function() {
                    ...
                    "yes" != r && "yes" != d && "yes" != o && ("false" == l.getAttribute("data-slider-with-cycle") && e == s ? e = s : e++,
            ...
            if (d) {
                ...
                if ("true" !== d.getAttribute("data-slider-stop"))
                    if ("true" !== d.getAttribute("data-swiper-initialized")) {
                        ...
                        var u = function t(e) {
                            window.pageYOffset > r.getBoundingClientRect().bottom + window.pageYOffset || window.pageYOffset + document.documentElement.clientHeight < r.getBoundingClientRect().top + window.pageYOffset ? d.setAttribute(e, "yes") : "y" !== d.getAttribute("data-slider-stopped-by-video") && d.setAttribute(e, "")
                        }, p = "ontouchend"in document ? "data-slider-touch" : "data-slider-stopped", f;
                        ...
                        if (1 != e) {
                            ...
                            hammer.on("pan", (function(e) {
                                if (o)
                                    return !1;
                                n = !0;
                                var s = r.querySelector(".t-slds__items-wrapper"), a = s.getAttribute("data-slider-items-in-row") || 0, d = a > 1, l = d ? r.querySelector(".t-slds__container .t-slds__item").offsetWidth : r.querySelector(".t-slds__container").offsetWidth, _ = parseFloat(s.getAttribute("data-slider-pos")), c = parseFloat(s.getAttribute("data-slider-totalslides")), u = "", p = e.deltaX, f = 100 / c * e.deltaX / window.innerWidth, m = 30, y;
                                if ("true" !== s.getAttribute("data-slider-stop") && (s.setAttribute("data-slider-touch", "yes"),
                                t_slds_scrollImages(t, l * _ - p),
                                e.isFinal)) {
                                    if (e.velocityX > .4)
                                        "false" == s.getAttribute("data-slider-with-cycle") && 1 == _ ? _ = 1 : _--,
                                        s.setAttribute("data-slider-pos", _),
                                        0 == _ && (u = "yes"),
                                        s.setAttribute("data-slider-cycle", u),
                                        t_slideMove(t, !1, i);
                                    else if (e.velocityX < -.4) {
                                        if ("false" == s.getAttribute("data-slider-with-cycle") && (_ == c || d && _ == c - a + 1))
                                            _ = d ? c - a : c;
                                        else {
                                        ...
                                        f <= -30 / c ? ("false" == s.getAttribute("data-slider-with-cycle") && (_ == c || d && _ == c - a + 1) ? _ = d ? c - a : c : _++,
                                        s.setAttribute("data-slider-pos", _),
                                        _ == c + 1 && (u = "yes"),
                                        s.setAttribute("data-slider-cycle", u),
                                        t_slideMove(t, !1, i)) : f >= m / c ? ("false" == s.getAttribute("data-slider-with-cycle") && 1 == _ ? _ = 1 : _--,
                                        s.setAttribute("data-slider-pos", _),
                                        0 == _ && (u = "yes"),
                                        s.setAttribute("data-slider-cycle", u),
                                        t_slideMove(t, !1, i)) : t_slideMove(t, !1, i);
                                    s.setAttribute("data-slider-touch", ""),
                                    n = !1
                                }
                            }
                            )),
...
function t_slds_changeImageUrl(t) {
    var e = document.getElementById("allrecords"), s = e && "yes" === e.getAttribute("data-tilda-lazy"), i = t_slds__getRec(t), r;
    i && (r = s ? i.querySelectorAll(".t-slds__img:not([data-original])") : i.querySelectorAll(".t-slds__img"),
    Array.prototype.forEach.call(r, (function(t) {
...
function t_triggerEvent(t, e) {
    var s;
    document.createEvent ? (s = document.createEvent("HTMLEvents")).initEvent(e, !0, !1) : document.createEventObject && ((s = document.createEventObject()).eventType = e),
    s.eventName = e,
    t.dispatchEvent ? t.dispatchEvent(s) : t.fireEvent ? t.fireEvent("on" + s.eventType, s) : t[e] ? t[e]() : t["on" + e] && t["on" + e]()
}
